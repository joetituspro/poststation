		...
		if (!empty($tasks)) {
			foreach ($tasks as $task) {
				...
				$status_list[] = [
					...
					'ai_total_tokens' => $task['ai_total_tokens'] ?? null,
					'ai_total_cost_usd' => $task['ai_total_cost_usd'] ?? null,
					'ai_call_count' => $task['ai_call_count'] ?? null,
					'ai_cost_unknown' => $task['ai_cost_unknown'] ?? null,
					'ai_tokens_estimated' => $task['ai_tokens_estimated'] ?? null,
