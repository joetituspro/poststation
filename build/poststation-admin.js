...
var checkStatus = function checkStatus(blockId) {
  return rest("poststation/v1/check-status?block_id=".concat(blockId));
};
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("h3", {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_common__WEBPACK_IMPORTED_MODULE_1__.Select, {
          ...
          disabled: !blocks.some(function (b) {
...
function PostWorkEditPage() {
  ...
  var _useMutation8 = (0,_hooks_useApi__WEBPACK_IMPORTED_MODULE_7__.useMutation)(function () {
    ...
    exportPostWork = _useMutation8.mutate;
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 10:
            ...
            console.error('Failed to create block:', _context.t0);
          case 13:
          case "end":
            return _context.stop();
        }
  ...
  var handleDeleteBlock = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(blockId) {
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
          ...
          case 6:
            ...
            console.error('Failed to delete block:', _context2.t0);
          case 9:
          case "end":
            return _context2.stop();
        }
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          ...
          case 16:
            ...
            console.error('Failed to duplicate block:', _context3.t0);
          case 19:
          case "end":
  ...
  var handleRunBlock = /*#__PURE__*/function () {
    ...
    return function handleRunBlock(_x3) {
      ...
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          ...
          case 7:
            ...
            console.error('Failed to import blocks:', _context5.t0);
            showToast((_context5.t0 === null || _context5.t0 === void 0 ? void 0 : _context5.t0.message) || 'Failed to import blocks.', 'error');
          case 11:
          case "end":
      ...
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          ...
          case 7:
            ...
            showToast((_context6.t0 === null || _context6.t0 === void 0 ? void 0 : _context6.t0.message) || 'Failed to clear completed blocks.', 'error');
          case 11:
          case "end":
  ...
  var handleRun = /*#__PURE__*/function () {
    var _ref9 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee8() {
      var toRun, _iterator, _step, _loop;
      return _regeneratorRuntime().wrap(function _callee8$(_context10) {
        while (1) switch (_context10.prev = _context10.next) {
          ...
          case 3:
            ...
            _context10.prev = 5;
            toRun = blocksList.filter(function (b) {
              return b.status === 'pending' || b.status === 'failed';
            });
            _iterator = _createForOfIteratorHelper(toRun);
            _context10.prev = 8;
            _loop = /*#__PURE__*/_regeneratorRuntime().mark(function _loop() {
              var block, _postWork$webhook_id, attempts, _loop2;
              return _regeneratorRuntime().wrap(function _loop$(_context9) {
                while (1) switch (_context9.prev = _context9.next) {
                  ...
                  case 3:
                    setBlocksList(function (prev) {
                      return prev.map(function (b) {
                        return b.id === block.id ? _objectSpread(_objectSpread({}, b), {}, {
                          status: 'processing'
                        }) : b;
                      });
                    });
                    _context9.prev = 4;
                    _context9.next = 7;
                    return runPostWork(block.id, (_postWork$webhook_id = postWork.webhook_id) !== null && _postWork$webhook_id !== void 0 ? _postWork$webhook_id : 0);
                  case 7:
                    attempts = 0;
                      ...
                      return _regeneratorRuntime().wrap(function _loop2$(_context8) {
                        while (1) switch (_context8.prev = _context8.next) {
                          ...
                          case 2:
                            _context8.prev = 2;
                            _context8.next = 5;
                            return (0,_api_client__WEBPACK_IMPORTED_MODULE_6__.checkStatus)(block.id);
                          case 5:
                  ...
                  case 9:
                    if (!(attempts < 60 && !stopRunRef.current)) {
                      _context9.next = 15;
                      break;
                    }
                  ...
                  case 17:
                    ...
                    setBlocksList(function (prev) {
                      return prev.map(function (b) {
                        return b.id === block.id ? _objectSpread(_objectSpread({}, b), {}, {
                          status: 'failed',
                          error_message: _context9.t1.message
                        }) : b;
                      });
                    });
                    showToast((_context9.t1 === null || _context9.t1 === void 0 ? void 0 : _context9.t1.message) || 'Block failed.', 'error');
                  case 21:
                  case "end":
      ...
      }, _callee8, null, [[5,, 25, 29], [8, 19, 22, 25]]);
    }));
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsxs)("div", {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(EditablePostWorkTitle, {
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_8__.jsx)(_components_common__WEBPACK_IMPORTED_MODULE_1__.Button, {
            ...
            onClick: handleRun,
            disabled: blocksList.filter(function (b) {
              return b.status === 'pending' || b.status === 'failed';
            }).length === 0,
            children: "Run"
          })]
